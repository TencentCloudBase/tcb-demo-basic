...
function callGeneralOpenAPI(method, options, config) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var res, tcbInstance, err_1, wxResp, jsonParseResult, jsonParseResult;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sleep()];
                case 1:
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    tcbInstance = instance_1.getInstance(config);
                    return [4 /*yield*/, tcbInstance[method]({
                            apiName: options.api,
                            requestData: options.data,
                        })
                        // console.log('wx-server-sdk tcb.callWxOpenApi res: ', res)
                ...
                case 5:
                    if (!Buffer.isBuffer(res)) {
                        ...
                        if (method === 'callCompatibleWxOpenApi') {
                            ...
                            return [2 /*return*/, jsonParseResult];
                        }
                    }
                    return [2 /*return*/];
            }
...
function callWXOpenAPI(options, config) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, callGeneralOpenAPI('callCompatibleWxOpenApi', options, config)];
        });
    });
}
exports.callWXOpenAPI = callWXOpenAPI;
function callWXPayAPI(options, config) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, callGeneralOpenAPI('callWxPayApi', options, config)];
        });
    });
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var namespace_1 = __webpack_require__(/*! ./namespace */ "./src/api/cloudpay/namespace/index.ts");
...
var msg_1 = __webpack_require__(/*! utils/msg */ "./src/utils/msg.ts");
var utils_1 = __webpack_require__(/*! utils/utils */ "./src/utils/utils.ts");
var generic_fn_1 = __webpack_require__(/*! utils/generic-fn */ "./src/utils/generic-fn.ts");
var type_1 = __webpack_require__(/*! utils/type */ "./src/utils/type.ts");
...
function getCloudPayAPIs(cloud) {
    ...
    function callCloudPayAPI(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var displayAPIName, data, wxResp, result, e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        displayAPIName = "cloudPay." + options.api;
                        if (!options) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, cloud.provider.api.callWXPayAPI({
                                api: options.api,
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, tslib_1.__assign({}, result, { errCode: 0, errMsg: displayAPIName + ":ok" })];
                    case 3:
                        e_1 = _a.sent();
...
Object.defineProperty(exports, "__esModule", { value: true });
var generic_1 = __webpack_require__(/*! ./generic */ "./src/api/cloudpay/namespace/generic.ts");
...
var cloudpay_1 = __webpack_require__(/*! ./cloudpay */ "./src/api/cloudpay/index.ts");
...
exports.getCallableObject = function (options) {
    var f = function () { };
    return new Proxy(f, {
        get: function (target, prop) {
            if (exports.functionIntrinsicProperties.has(prop)) {
                ...
                return exports.getCallableObject(tslib_1.__assign({}, options, { paths: tslib_1.__spread(options.paths, [prop]) }));
            }
        },
...
exports.getProxyObject = function (options) {
    var o = {};
    return new Proxy(o, {
        get: function (target, prop) {
            return exports.getCallableObject(tslib_1.__assign({}, options, { paths: [prop] }));
        }
    });
};
